...
\begin{tabular}{ccc}
\hline
\                          &  Goodreads Authors/Users    &   1st degree connection & All        \\ \hline
...
% distribution - column chart - 8 buckets (0-10, 11-20, 21-30... 80+) -> fix bukcet size depending on the data

% column chart 
% Average rating a user has given - - I want total average
% distribution of a user -average rating - column chart - 8 buckets (0.1-0.5, 0.6-1... 4.5-5)
