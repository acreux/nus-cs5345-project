...
# same_rating_high
    ...
    scores = ["same_rating", "same_rating_high"]
    threshold = [0, 0, 0, 0, 0]
    sample_filename = sample_reviews(3000, "3000_1")

    r = Reviews(sample_filename)
    for score, t in zip(scores, threshold):
        reviews_filenames = r.user_to_user(score=score, threshold=0, chunksize=30000, process=10)
